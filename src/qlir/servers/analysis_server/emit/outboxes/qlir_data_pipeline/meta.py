"""Canonical declaration for the `qlir-data-pipeline` outbox.

The package directory name (`qlir_data_pipeline`) is a Python module name and must use
