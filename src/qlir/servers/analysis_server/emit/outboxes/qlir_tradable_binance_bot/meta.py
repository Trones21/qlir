"""Canonical declaration for the `qlir-tradable-binance-bot` outbox.

The package directory name (`qlir_tradable_binance_bot`) is a Python module name and must use
...
OUTBOX = {
    "name": "qlir-tradable-binance-bot",
