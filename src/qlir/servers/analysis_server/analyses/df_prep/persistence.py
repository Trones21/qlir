...
def persistence_analysis(df: pd.DataFrame, trendline_col: str) -> list[NamedDF]:
    ...
    for_up_pers_df, _ = persistence_analysis_prep_up(df, direction_col, trendline_col)
    ...
    for_down_pers_df, _ = persistence_analysis_prep_down(df, direction_col, trendline_col)
